...
% <ret> is matrix of size <number of hidden units> by <number of visible units>
    ...
    visible_state_2 = sample_bernoulli( visible_prob );
    
    %For Q7
    %hidden_prob_2 = visible_state_to_hidden_probabilities(rbm_w, visible_state_2);
    %hidden_state_2 = sample_bernoulli( hidden_prob_2 );
